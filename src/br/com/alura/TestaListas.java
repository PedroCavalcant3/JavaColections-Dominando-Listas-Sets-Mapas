...
public class TestaListas {
    ...
    public static void main(String[] args) {
    	...
    	/*código abaixo que testa a inserção de 1 milhão de elementos com ArrayList e LinkedList, medindo o tempo. Além disso, estamos removendo 100 elementos, 
    	  sempre tirando do início da lista. Execute e veja a diferença:*/
